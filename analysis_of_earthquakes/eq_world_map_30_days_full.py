...
for eq_dict in all_eq_dicts:
    mags.append(eq_dict['properties']['mag'])  # Видобуваємо послідовно кожну магнітуду. Додаємо значення у словник mags
    lons.append(eq_dict['geometry']['coordinates'][0])  # Видобуваємо послідовно кожну довготу
    lats.append(eq_dict['geometry']['coordinates'][1])  # Видобуваємо послідовно кожну широту
    hover_texts.append(eq_dict['properties']['title'])  # Секція 'title' в файлі містить опис магнітуди та локації
